...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    e.preventDefault();
    emailjs.sendForm("service_smjzi7v", "template_zs0kw3d", formRef.current, {
      publicKey: "lRlMZdT2mmwabgns8",
    }).then(
      () => {
        console.log("success");
    ...
    >
      <motion.div className="infoContainer" variants={variants}>
        ...
        <motion.div className="info" variants={variants}>
          <h3>Mail</h3>
          <p>azdineserhani1@gmail.com</p>
        </motion.div>
        <motion.div className="info" variants={variants}>
          <h3>Address</h3>

          <p>Morrocco Ksar El Kebir</p>
        </motion.div>
        <motion.div className="info" variants={variants}>
          <h3>Phone</h3>
          <p>+212636241246</p>
      ...
      <motion.div className="formContainer" variants={variants}>
        ...
        >
          ...
          <motion.input
            ...
            variants={variants}
          />
          <motion.textarea placeholder="Message" name="message" rows={5} variants={variants} />
